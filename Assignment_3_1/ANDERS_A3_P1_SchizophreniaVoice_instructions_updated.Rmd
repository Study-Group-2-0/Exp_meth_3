...
df <- merge(demo, pitch_data, by = c("Participant", "Study", "Diagnosis"), all = T)
...
# Now we merge them
df1 <- merge(df, dur, by = c("Participant", "Study", "Diagnosis", "Trial"), all = T)
