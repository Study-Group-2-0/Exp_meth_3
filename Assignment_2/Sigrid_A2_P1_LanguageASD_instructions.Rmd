...
ggplot(test, aes(X, CHI_MLU)) + geom_point() + geom_smooth(method = 'lm', color = 'blue') +
  geom_point(aes(X, FIT, color = 'red')) + geom_smooth(method = 'lm', color = 'red') + labs(x = 'Subject', y = 'Child_MLU') + theme(legend.position = 'none')

# how many rows contain N/As
df[!complete.cases(df),]

# rows of MLU CHI with NA's
df[!complete.cases(df$CHI_MLU),]
