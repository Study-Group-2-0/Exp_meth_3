...
#Loading packages
pacman::p_load(tidyverse, lmerTest, lme4, ggplot2, MuMIn)
...
#making subsets with ASD and TD
...
#interaction er godt, random slope er godt
```
...
predictt <- as.data.frame(predict(nl1))
SUBJ <- seq.int(1:346)
predictt$row <- SUBJ
