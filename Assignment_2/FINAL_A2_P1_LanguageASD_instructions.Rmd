...
author: "Sigrid Snapfield, Anders Wheelman, Gustav Helmet"
date: "15/09/2020"
...
#The plot indicates that there might be an interaction effect between age and diagnosis. 
df %>% 
  ggplot()+
...
#Making a model with different curve model:
...
df %>% 
  ggplot()+
  aes(x= Age, y= MOT_MLU, colour = Diagnosis)+
  geom_point()+
  geom_smooth(method = lm, alpha = 0, size = 1) + labs(x = 'Age (months)', y = 'Mother MLU', title = 'Mother MLU according to the age and the diagnosis of the child')
