...
m1 <- lme4::lmer(CHI_MLU ~ Diagnosis + Visit + (Visit|Subject)+I(Visit^2), data_train, REML = F) 
summary(m1)
```
...
powerCurveV <- powerCurve(m1, simr::fixed("Visit"), along = "Subject", nsim = 50 )
powerCurveV
...
```{r}
m2 <- simr::extend(m1, along = "Subject", n=30)
summary(m2)
