...
```{r}
# Load the libraries
pacman::p_load(tidyverse, groupdata2, gridExtra)
...
```{r}
#processing data further. Removing Na's
data <- data %>% 
  filter(
    !is.na(time),
    !is.na(HR1),
...
```{r}
#After looking through all the plots
#Excluding the following files (see rapport for more information)
