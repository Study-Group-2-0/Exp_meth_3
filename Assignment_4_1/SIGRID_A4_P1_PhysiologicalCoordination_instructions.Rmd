...
read_data <- function(filename) {
    ...
    data <- data %>% mutate(
      ...
      Condition = substr(filename, 14, nchar(filename)-5),
...
test_data = read_data("Study2_G10_T2_TurnTaking.csv")
...
```{r}
# Load the file
file <- read_csv('data/Study1_G1_T1_Synchronous.csv')

# Plot
#file_melt <- melt(file)
#ggplot() + geom_path(file, aes(time, 'Resp1')) + geom_path(file, aes(time, 'Resp2'))
